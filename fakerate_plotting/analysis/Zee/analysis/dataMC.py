...
if __name__ == '__main__':
    ...
    try:
        if sys.argv[1] == "cut_1prong":
    	    ...
    	    if sys.argv[2] == "cut_tau_id_loose":
                 ...
                 scriptName = "dataMC_reweighted_1prong_tau_id_loose"
            elif sys.argv[2] == "cut_tau_id_medium":
                 selection = selection & cut_tau_id_medium
                 scriptName = "dataMC_reweighted_1prong_tau_id_medium"
            elif sys.argv[2] == "cut_tau_id_tight":
                 selection = selection & cut_tau_id_tight
                 scriptName = "dataMC_reweighted_1prong_tau_id_tight"
    except:
	selection = sel_lep & sel_tag & sel_tau
	scriptName = "dataMC_reweighted"
	...
	for process in xmlParser.physicsProcesses:
	    for dataset in process.datasets:
                hist_store = HistogramStore("histogramStore/dataMC_reweighted.root")
    ...
    variables = [
	    ...
	    var_tau0_ntracks, var_tau0_q, var_tau0_pt_fine, var_tau0_eta_equal, var_tau0_phi, 
	    var_tau0_match, var_tau0_TATmatch, var_tau0_proper_pdgId,
	    var_weight_ZptSF,
	    var_tau0_pt,
	    ]
